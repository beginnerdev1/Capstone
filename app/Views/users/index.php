          ...
          <div class="row text-center mb-4">
            ...
            <div class="col-md-4">
              <div class="p-4 rounded-4 bg-light mb-3">
                ...
                <small class="text-muted">8AM-5PM Response</small>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="accordion accordion-flush" id="faqAccordion">
            <div class="accordion-item border-0 mb-2 rounded-3">
              ...
              <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Simply click on "Pay Bills" in your dashboard to view all outstanding bills. You can pay using GCash Payment Gateway, Manual Gcash Payment and Over the Counter method.
                </div>
              </div>
            </div>
            <div class="accordion-item border-0 mb-2 rounded-3">
              ...
              <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Bills are generated by BWASA each month.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item border-0 mb-2 rounded-3">
              ...
              <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Each month user can pay partially and if the user don't pay on specific month it will be added to the next billing. Contact our Admin team immediately if you're having trouble making payments.
                </div>
              </div>
            </div>
          </div>
